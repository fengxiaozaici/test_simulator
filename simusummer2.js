...
var upcraft4=new Array("297");
var craft3=new Array("072","089","090","091","092","093","094","095","096","177","243","244","245","246","247","265");
var upcraft3=new Array("298");
...
function getOne(i,j){
    ...
    if(rand<0.01){ //5,servant
        log[i]=0;
        if(rand<0.0065){    //up
            imgurl="http://file.fgowiki.591mogu.com/fgo/head/129.jpg";
